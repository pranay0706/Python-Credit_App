...
MODEL_DIR_1 = os.path.join(ROOT_DIR, MODEL_FILE_NAME)
...
TRANSFORMER_DIR_1= os.path.join(ROOT_DIR, TRANSFORMER_FILE_NAME)
...
#Load The Model
model=pickle.load(open(MODEL_DIR_1,"rb"))
print(model)
transfomer=pickle.load(open(TRANSFORMER_DIR_1,"rb"))
print(transfomer)
